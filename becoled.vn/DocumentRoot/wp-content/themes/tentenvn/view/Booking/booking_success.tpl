            ...
            <div style=" color: #FBCB09;width: 958px; float: left; margin: 0px 5px; text-align: center; padding: 5px 0px;">
                <div style="float: left;width: 98% ;margin-left: 5px;" >
                    <div style="float: left;color: #333;margin-top: 5px;">
                        {if $flg_s==1}
                            <ul style="list-style: none;text-align: left;float: left;margin-left: 5px;">
                                <li>
                                    Your request for quote on {$smarty.const.NAME_LOGO} is completed. 
                                </li>
                                <li>
                                    We will sent you the quote very soon. 
                                </li>
                                <li>
                        ...
                        {else if $flg_s==2}
                            <ul style="list-style: none;text-align: left;float: left;margin-left: 5px;">
                                <li>
                                    Your order on {$smarty.const.NAME_LOGO} is complete. 
                                </li>
                                <li>
                                    -  <a href="{$smarty.const.SITE_URL}Account/listOrder/{$state_pay}">View Order #{$state_pay}</a> 
                                </li>
                                <li>
                                    -  <a href="{$smarty.const.SITE_URL}Ajax/dowload_pdf/{$state_pay}">Download Invoice #{$state_pay}</a>  
                                </li>
                                <li>
                                   For any questions or for further information, please contact our customer support.
                                </li>
                        ...
                        {else}
                            <ul style="list-style: none;text-align: left;float: left;margin-left: 5px;">
                                ...
                                <li>
                                    - Total amout of ${$dataOrder['total_price']} 
                                </li>
                                <li>
                                    -  <a href="{$smarty.const.SITE_URL}Account/listOrder/{$dataOrder['order_id']}">View Order #{$dataOrder['order_id']}</a> 
                                </li>
                                <li>
                                    -  <a href="{$smarty.const.SITE_URL}Ajax/dowload_pdf/{$dataOrder['order_id']}">Download Invoice #{$dataOrder['order_id']}</a>  
                                </li>
                                <li>
                                   An e-mail with the above information has been sent to your provided e-mail address.	
                                </li>
                                <li>
                                   You can also view the invoice at any time using the "ORDERS" link at the top right of the page.	
                                </li>
                                <li>
                                   For any questions or for further information, please contact our customer support.
                                </li>
                ...
                <div style="float: left;color: #333;margin-top: 5px;width: 90%;text-align: left;">
                    <div style="float: left;color: #333;margin-top: 5px;width: 90%;text-align: center;">
                        <a href="{$smarty.const.SITE_URL}Account/listOrder"> <img src="{$smarty.const.SITE_URL}images/order.gif" alt="order" class="icon"/> Back to orders</a>
                    </div> 
                </div> 
            </div>
        </div>
