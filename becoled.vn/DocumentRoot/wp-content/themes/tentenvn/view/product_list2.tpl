<div class="block-list-sp">
    ...
    <{$dataProduct=$arrProductAll}>

    <div class="block-content">

       <{if count($arrProductAll)>0}>
		<p>có <{count($arrProductAll)}> kết quả nào cho từ khóa "<b><{$keywords}></b>".</p>
    ...
    <p>Không có kết quả nào cho từ khóa "<b><{$keywords}></b>".</p>
