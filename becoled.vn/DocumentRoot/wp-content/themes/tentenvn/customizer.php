...
function weblizar_gl_customizer( $wp_customize ) {
	...
	$port['5'] = esc_url(get_template_directory_uri() ."/images/portfolio5.png"); 
	$port['6'] = esc_url(get_template_directory_uri() ."/images/portfolio6.png"); 
	$port['7'] = esc_url(get_template_directory_uri() ."/images/portfolio7.png"); 
	$port['8'] = esc_url(get_template_directory_uri() ."/images/portfolio8.png"); 
