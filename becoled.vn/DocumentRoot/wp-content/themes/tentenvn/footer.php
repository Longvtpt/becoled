...
<div class="enigma_footer_area">
		<div class="container">
			...
			<?php if($wl_theme_options['']) { echo esc_attr($wl_theme_options['']); }
			if($wl_theme_options['']) { echo "|" .esc_attr($wl_theme_options['']); } ?>
			<a target="_blank" rel="nofollow" href="<?php if($wl_theme_options['']) { echo esc_url($wl_theme_options['']); } ?>"><?php if($wl_theme_options['']) { echo esc_attr($wl_theme_options['']); } ?></a></p>
